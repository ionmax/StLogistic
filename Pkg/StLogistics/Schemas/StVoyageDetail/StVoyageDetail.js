define("StVoyageDetail", ["ConfigurationGrid", "ConfigurationGridGenerator",
	"ConfigurationGridUtilitiesV2", "StTestWebsocketMessageMixin"], function() {
	return {
		...
		methods: {
			onActiveRowAction: function(buttonTag, primaryColumnValue) {
				...
				this.mixins.StTestWebsocketMessageMixin.SubscribeOnShowInformationWindowTest();
			},
			destroy: function(){
				this.mixins.StTestWebsocketMessageMixin.UnSubscribeOnShowInformationWindowTest();
			}
		},
		diff: /**SCHEMA_DIFF*/[
			{
